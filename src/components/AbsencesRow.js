          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                ...
                onChange={handleToggleAbsence}
                name={props.absence.id}
              />
            }
            label="Igazolt -"
          />
          <Typography display="inline" sx={{ color: "gray", fontSize: 10 }}>
            {props.absence.Datum.toDate().toLocaleDateString("en-US")}
          </Typography>
        </Box>
      </Stack>
      <Dialog
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <Typography>
              Dátum: {props.absence.Datum.toDate().toLocaleDateString("en-US")}
            </Typography>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
